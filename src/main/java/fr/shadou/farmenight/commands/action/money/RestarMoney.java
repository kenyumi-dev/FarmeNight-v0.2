...
public class RestarMoney implements Command<CommandSource> {
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        CapaMoney.getMoney(player).ifPresent(money -> {money.setMoney(0);System.out.println(money.getMoney());this.money=money.getMoney();});
