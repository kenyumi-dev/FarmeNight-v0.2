...
public class ValidationGui extends Screen {
    ...
    protected ValidationGui(ITextComponent p_i51108_1_, ItemStack itemStack, int nbtItem,int amount, int price, PlayerEntity player) {
        super(p_i51108_1_);
    ...
    protected void init() {
        ...
        addButton(new ImageButton(relX+140,relY+22,33,10,0,0,0,SOUS_TEXTURES,33,10,button-> {
            ...
            if (this.amount>=0 & this.nbtItem>=0){
                createinitnbt();
            }
        }));
    ...
    public void createinitnbt(){
        Minecraft.getInstance().setScreen(new ValidationGui(NAME,this.itemchoisi,this.nbtItem,this.amount,this.price,this.player));
    }
